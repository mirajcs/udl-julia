...
# ╔═╡ 83ae517a-b144-11f1-8978-33691cfbdb6e
using Symbolics

# ╔═╡ fe3a2def-a730-4bb7-980c-34d065522d9f
using Latexify

# ╔═╡ d9f8e309-fe1c-400d-9c43-e11bc519d5bf
@variables x

# ╔═╡ 1cd8e9ff-3232-4605-8a7a-0897e29ac130
y = exp(exp(x) + (exp(x))^2) + sin(exp(x) + (exp(x))^2)

# ╔═╡ f5f51306-5a28-4c80-abb3-d940aa9fd5b1
Symbolics.derivative(y, x)
