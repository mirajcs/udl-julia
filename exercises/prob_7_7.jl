...
# ╔═╡ 6d73ec3c-aebf-11f1-9fc4-21a8097afdf0
using Symbolics

# ╔═╡ 048dc679-cbdf-4ee1-ac73-7e14884d9da6
using SymbolicUtils

# ╔═╡ b82057fc-017e-4c87-879e-7a141badba1a
using Latexify

# ╔═╡ 03a816e6-f077-43d3-9654-645d8a9a3e00
@variables f

# ╔═╡ 95295b46-1b46-4a34-9720-b0464df82f17
fsym = Symbolics.value(f)

# ╔═╡ df86bbe1-ecd3-4a96-8dd1-1c76b407b48a
h(f) = 1/(1 + exp(-f))

# ╔═╡ d1e24298-2020-4551-b233-fcb02423a89e
∂h∂f = simplify(Symbolics.derivative(h(f), f))

# ╔═╡ 55913115-993c-45dd-8fb4-6f070d7362d1
limit(Symbolics.value(∂h∂f), fsym, Inf)

# ╔═╡ 0c2ae4d1-b2fa-408b-abc1-56c7451b19ec
limit(Symbolics.value(∂h∂f), fsym, -Inf)
...
manifest_format = "2.0"
project_hash = "58717e622510564261431b55cb09f2e4de2033bb"
