...
# ╔═╡ 100875e0-ac42-11f1-b5a7-3d6e10489c33
using Symbolics

# ╔═╡ b0ff1b0a-0632-4e1a-9b73-6b660e8b5e88
using Latexify

# ╔═╡ 757fb73c-c518-45df-b75c-370cbdace2b8
md"¹ means the intermediate derivatives "

# ╔═╡ bff5fc95-8fcb-482d-b2aa-2a8bb23fce4c
@variables β₀ ω₀ xᵢ β₁ ω₁ β₂ ω₂ β₃ ω₃ yᵢ f₃¹ h₃¹ f₂¹ h₂¹ f₁¹ h₁¹ f₀¹

# ╔═╡ abea0600-8323-4aa8-969b-e12e1f493dec
f₀(β₀, ω₀, xᵢ) = β₀ + ω₀ * xᵢ

# ╔═╡ 8035249d-4bf8-43f9-8ace-81c569145c81
h₁(u) = sin(u)

# ╔═╡ 2b556adc-b3dd-4e49-938a-e526b6150bae
f₁(β₁, ω₁, u) = β₁ + ω₁ * u

# ╔═╡ 8cbb821b-5e49-4a93-a380-683225a4f4c5
h₂(u) = exp(u)

# ╔═╡ 26d9b442-8a21-4acc-891c-efaf42baf125
f₂(β₂, ω₂, u) = β₂ + ω₂ * u

# ╔═╡ 7cfc3842-9980-4e67-831f-47b92764fee5
h₃(u) = cos(u)

# ╔═╡ 4f602edb-ca55-4aff-b82b-fa021855b7cb
f₃(β₃, ω₃,  u) = β₃ + ω₃ * u

# ╔═╡ cd09ada1-1812-4883-a43f-25d057282284
fᵢ = f₃(β₃, ω₃, h₃(f₂(β₂, ω₂, h₂(f₁(β₁, ω₁, h₁(f₀(β₀, ω₀, xᵢ)))))))

# ╔═╡ 35588b9a-3115-44bb-8316-1e9175221132
lᵢ(u, yᵢ) = (u - yᵢ)^2

# ╔═╡ f45a4d60-f620-4d6f-b68c-94749617ea0d
loss = lᵢ(fᵢ, yᵢ)

# ╔═╡ b9308774-c517-4f31-a4c0-24d0c85d7da2
∂lᵢ∂f₃ = Symbolics.derivative(lᵢ(f₃¹, yᵢ), f₃¹)

# ╔═╡ 1554fb31-9bcb-4419-a0df-4b0fea8735ac
∂f₃∂h₃ = Symbolics.derivative(f₃(β₃, ω₃, h₃¹), h₃¹ )

# ╔═╡ 48591add-c281-4e6c-b50e-3236fcb01551
∂h₃∂f₂ = Symbolics.derivative(h₃(f₂¹), f₂¹)

# ╔═╡ 04a49813-5f50-4f82-bc3f-65e3640d704d
∂lᵢ∂f₂ = ∂h₃∂f₂*(∂f₃∂h₃*∂lᵢ∂f₃)

# ╔═╡ 66f02bc7-fea6-4844-89c6-ca4c013b76b0
∂f₂∂h₂ = Symbolics.derivative(f₂(β₂, ω₂, h₂¹), h₂¹)

# ╔═╡ 4bdc5c71-4466-4f6e-89d9-57775b981f37
∂lᵢ∂h₂ = ∂f₂∂h₂*∂lᵢ∂f₂ 

# ╔═╡ b23816e3-5eb6-4d58-8f0a-e8206c4df9c8
∂h₂∂f₁ = Symbolics.derivative(h₂(f₁¹), f₁¹)

# ╔═╡ c7080ec8-3f39-4be7-bb94-28f700d331cc
∂hᵢ∂f₁ = ∂h₂∂f₁*∂lᵢ∂h₂

# ╔═╡ 5cd06737-6243-4349-afe2-00ad4cdf50cd
∂f₁∂h₁ = Symbolics.derivative(f₁(β₁, ω₁, h₁¹), h₁¹)

# ╔═╡ 969173fe-e972-4cab-af2e-d68525c4e436
∂lᵢ∂h₁ = ∂f₁∂h₁*∂hᵢ∂f₁

# ╔═╡ 558f7036-1c16-4673-b53a-aee6b6aa41a0
∂h₁∂f₀ = Symbolics.derivative(h₁(f₀¹), f₀¹)

# ╔═╡ 53e13d8b-3c34-402c-8b40-1aa787c4367d
∂lᵢ∂f₀ = ∂h₁∂f₀* ∂lᵢ∂h₁

# ╔═╡ 7b703bd0-0030-4b8d-b9e2-82a36aa44e43
substitute(∂lᵢ∂f₀, Dict(
	f₀¹ => f₀(β₀, ω₀, xᵢ),
	f₁¹ => f₁(β₁, ω₁, h₁(f₀(β₀, ω₀, xᵢ))),
	f₂¹ => f₂(β₂, ω₂, exp(f₁(β₁, ω₁, h₁(f₀(β₀, ω₀, xᵢ))))),
	f₃¹ => f₃(β₃, ω₃,  h₃(f₂(β₂, ω₂, exp(f₁(β₁, ω₁, h₁(f₀(β₀, ω₀, xᵢ)))))))
))
...
manifest_format = "2.0"
project_hash = "75ad01427d9d9d7cc85749c52d515a350a52d586"
