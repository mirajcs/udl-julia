...
# ╔═╡ 8d888018-abbc-11f1-874a-5f1d1571be31
using Symbolics

# ╔═╡ fd95e2b9-0f5c-4e89-a440-8d7321c07abb
using Latexify

# ╔═╡ da1dccd3-c454-41f4-bc61-e168c9c2be2b
a(x) = ifelse(x>0, x, zero(x)) 

# ╔═╡ a4381cc6-82d8-4646-bd68-e50273d5a2e9
@variables x ϕ₀ ϕ₁ ϕ₂ ψ₀₁ ψ₁₁ ψ₂₁ ψ₀₂ ψ₁₂ ψ₂₂ θ₀₁ θ₁₁ θ₀₂ θ₁₂

# ╔═╡ 468c585b-4de2-48c4-8fbb-f8a0c0047c6e
f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂) = ϕ₀ + ϕ₁*a(ψ₀₁ + ψ₁₁ * a(θ₀₁ + θ₁₁*x) + ψ₂₁ * a(θ₀₂ + θ₁₂*x)) + ϕ₂ * a(ψ₀₂ + ψ₁₂ * a(θ₀₁ + θ₁₁*x) + ψ₂₂ * a(θ₀₂ + θ₁₂ * x))

# ╔═╡ c0545d0b-4526-4f6c-b222-84abc6c190e1
f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂)

# ╔═╡ 6464c50f-9936-4b49-9b60-68c75d28e8b5
Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), ϕ₀)

# ╔═╡ 52bbb690-45af-4535-9bf0-8ec6f75b0b50
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), ϕ₁))

# ╔═╡ 91f6f2bf-1a38-494d-90be-1c43874c011d
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), ϕ₂))

# ╔═╡ 5965c793-c89b-4c25-a456-b6c7d56e7919
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), ψ₀₁))

# ╔═╡ 5165ee2b-d651-4457-9fba-599ef0e8b7ef
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), ψ₁₁))

# ╔═╡ 1c339086-cf68-4664-be2e-a7fd5088393d
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), ψ₂₁))

# ╔═╡ 3f33e6ce-4a27-4fed-a042-87d21ef34a92
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), ψ₀₂))

# ╔═╡ 8a65391e-f2c5-41d1-8f60-d9a0caeed47f
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), ψ₁₂))

# ╔═╡ 095a1fa3-7ad1-494d-9125-521cd60954a9
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), ψ₂₂))

# ╔═╡ 7120be97-fa0d-45ea-b411-2c0444051db4
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), θ₀₁))

# ╔═╡ 061cd256-3646-459a-b36d-c9d33bdc799f
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), θ₁₁))

# ╔═╡ fe161248-8449-41de-96db-18c7ed2b36b7
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), θ₀₂))

# ╔═╡ 1ca7a1b7-0492-4521-9fbf-6b757281b116
simplify(Symbolics.derivative(f(ϕ₀, ϕ₁, ϕ₂, ψ₀₁, ψ₁₁, ψ₂₁, ψ₀₂, ψ₁₂, ψ₂₂, θ₀₁, θ₁₁, θ₀₂, θ₁₂), θ₁₂))
