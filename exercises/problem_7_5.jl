...
# ╔═╡ a4c6be2e-ae10-11f1-909f-fdb7d27bdf35
using Symbolics

# ╔═╡ a9424f28-6465-461c-ba0d-4e7e0a24f4db
using Latexify

# ╔═╡ 3a67d59c-c234-43c0-a063-b37cd60dadfc
@variables y f 

# ╔═╡ d72220de-4989-481d-b8ac-4fa7bed2049a
sig(z) = 1 / (1 + exp(-z))

# ╔═╡ f76802a8-4050-4fc7-a0b1-6b271de6d07e


# ╔═╡ 13ceaa45-fbc0-430b-b996-524857ea0102
loss = -(1-y)*log(1- sig(f)) - y*log(sig(f))

# ╔═╡ c6ca64b7-551f-424a-ac87-98daf9036056
simplify(Symbolics.derivative(loss, f))
