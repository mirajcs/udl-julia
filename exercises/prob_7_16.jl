...
# ╔═╡ 2e03827c-b379-11f1-aed2-c9babff77967
using Lux, Random, Optimisers, Zygote, MLUtils, Printf,CairoMakie

# ╔═╡ 7977637c-4ba6-4a96-b870-2c8355074f00
md"Define input size, hidden layer size, output size"

# ╔═╡ b9a0b9dd-885f-45dc-b0e3-51ad4d751903
Dᵢ, Dₖ, D₀ = 10, 40, 5

# ╔═╡ 3c943a82-69cd-4e78-9789-03604870978c
begin
	rng = Random.default_rng()
	Random.seed!(rng, 0)
end 

# ╔═╡ ce07ea40-e3c3-44f5-8c51-8df6e5a977ea
md"Create model with two hidden layers, He initialization of weights, biases set to zero. "

# ╔═╡ 02befdaa-462a-4f54-8045-839749dfecd6
model = Chain(
...
# ╔═╡ 6c1c6bdb-9beb-40e3-94f9-f8a0c87bcc11
md"Parameters and states live outside the model in Lux."

# ╔═╡ 1902df3c-398b-4eef-8f50-a5b555ad0c2c
ps, st = Lux.setup(rng, model)

# ╔═╡ 18ce6e77-0402-4030-9b63-ec884c8f0fb8
md"Choose least squares loss function. "

# ╔═╡ eec429a3-2fb8-4b99-8cea-5cfb1db1a2cf
criterion = MSELoss()

# ╔═╡ 0e809361-a7b9-4e57-b3d0-f752a9dbf4be
md"SGD with momentum; learning rate is halved every 10 epochs below."

# ╔═╡ 648de94a-ee11-46eb-96d7-4cafbe52b4c6
opt = Optimisers.Momentum(0.1f0, 0.9f0)

# ╔═╡ 0a96bf0c-2bd7-4e30-99f9-980ed5314510
md"Create 100 random data points and store in a data loader. "

# ╔═╡ 640ffb1a-a1b2-4a9d-a26e-e51b6745395d
begin
	x = randn(rng, Float32, Dᵢ, 100)
	y = randn(rng, Float32, D₀, 100)
	data_loader = DataLoader((x,y); batchsize=10, shuffle = true)
end 

# ╔═╡ d1ae197f-e190-458e-8773-8dc31e9a0778
md"Bundels model, parameters, states, optimizer and its state"

# ╔═╡ c47db1f6-cd8c-4041-81f4-2eae9fff8bc2
md"loop over the dataset 100 times."

# ╔═╡ 9acd752d-fdf5-4ea7-b63c-c8da69bf220b
...
# ╔═╡ beb63d2c-b174-4a53-ba04-49f6a2b80c8c
losses, train_state = train(model, ps, st, opt, criterion, data_loader)

# ╔═╡ 6ba7d263-a585-41b4-a3db-f6a915247059
md"Plot the training loss"

# ╔═╡ 72087ea6-575a-4831-a240-51bf6b347f78
...
# ╔═╡ 640b5f65-3adb-4043-a3e0-a6ba44af652c
PlotLosses(losses)
...
manifest_format = "2.1"
project_hash = "8825320c96e2f1aea7f318c02bf758dec6869b5f"
