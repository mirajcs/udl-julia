...
# ╔═╡ ccff97ec-b8dd-11f1-9974-ff8e4d4db388
using Symbolics, Latexify

# ╔═╡ dfcb678f-42bb-454c-909b-1adaa7fa176f
@variables y₁ y₂ y₃ β₁ β₂ β₃ Ω₁₁ Ω₁₂ Ω₁₃ Ω₂₁ Ω₂₂ Ω₂₃ Ω₃₁ Ω₃₂ Ω₃₃ x₁ x₂ x₃

# ╔═╡ 6d34912c-f719-46fd-869e-76c9823dab5f
β = [β₁; β₂; β₃]

# ╔═╡ 2ad3e316-a9f3-48e6-9568-b85c5962f71b
Ω = [Ω₁₁ Ω₁₂ Ω₁₃; Ω₂₁ Ω₂₂ Ω₂₃; Ω₃₁ Ω₃₂ Ω₃₃]

# ╔═╡ 4362db6b-cebf-4d6b-a573-5067ef3744ec
x = [x₁; x₂; x₃]

# ╔═╡ e603029f-bed4-492c-9071-e34422660802
typeof(Ω)

# ╔═╡ bf87e1dc-3279-4427-9cab-2cb8c68e5f87
y = reshape(β + Ω*x, :, 1)

# ╔═╡ 2b128afb-373b-4e80-ad27-06dfdd220b4e
A = [1 Ω₁₁ Ω₁₂ Ω₁₃; 1 Ω₂₁ Ω₂₂ Ω₂₃; 1 Ω₃₁ Ω₃₂ Ω₃₃]

# ╔═╡ e9ae33c9-35a1-444e-8fa3-1708c2112a74
x_new = [1; x₁; x₂; x₃]

# ╔═╡ 8897340d-f298-46eb-a68b-370263e571e4
A*x_new

# ╔═╡ 0e728799-21bf-4d56-bf65-358b48e4adb8
[ones(length(x))'; (x .- (0:2)/3)']

# ╔═╡ 572a373e-feea-4218-81e6-9172c415a5bc
(x .- (0:2)/3)'
