...
# ╔═╡ e2f033c7-4d39-4788-b129-1495f379109b
using Symbolics

# ╔═╡ b73495d4-f639-4587-81a4-4783e276f912
using Latexify

# ╔═╡ 6850b278-ad23-11f1-9aaa-f51c2826759c
md"# Notebook 7.1 - Backpropagation in Toy Model

This notebook computes the derivatives of the toy function discussed in section 7.3 of the book."

# ╔═╡ 3c68202e-a0a4-46c1-8eda-1df8ec69b4c8
md"We're going to investigate how to take the derivatives of functions where one operation is composed with another, which is composed with a third and so on.  For example, consider the model:
...
# ╔═╡ 448a5278-7d82-4ff5-b4ea-888c848f112c
md"Let's first define the original function for  𝑦  and the loss term:"

# ╔═╡ 91a6321f-faba-4752-afbb-51e2130e4ef1
@variables x β₀ β₁ β₂ β₃ ω₀ ω₁ ω₂ ω₃ y

# ╔═╡ b7de4936-ddbe-41d4-8e68-de18d5e4cab9
function fn(x, β₀, β₁, β₂, β₃, ω₀, ω₁, ω₂, ω₃)
	return β₃ + ω₃ * cos(β₂ + ω₂*exp(β₁ + ω₁*sin(β₀ + ω₀*x)))
end

# ╔═╡ 46b2d067-aac6-482f-ab71-158830152b64
fn(x, β₀, β₁, β₂, β₃, ω₀, ω₁, ω₂, ω₃)

# ╔═╡ 60346367-2b52-4dab-9a3c-2460c7634d1b
function loss(x, y, β₀, β₁, β₂, β₃, ω₀, ω₁, ω₂, ω₃)
	return (fn(x, β₀, β₁, β₂, β₃, ω₀, ω₁, ω₂, ω₃) - y)^2
end
