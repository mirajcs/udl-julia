...
# ╔═╡ 56dca404-48db-472f-8e13-cbe482d9789a
using Plots

# ╔═╡ c74e78ec-8606-11f1-9665-51098576b867
...
# ╔═╡ 4911d75f-5f94-47af-b6c7-cd81a982e6eb
md"Define ReLu Function"

# ╔═╡ 245db0c9-4a90-4bbd-ad18-07313fc6889c
function ReLU(preactivation)
    activation = max.(0.0, preactivation)
    return activation 
end 

# ╔═╡ 9805e208-ce7c-49f0-9392-3817cc70255b
md"Define a shallow neural network with one input, and three hidden units "

# ╔═╡ 2b12cf58-aab0-4c67-860c-50f6cd9f4ecd
...
md"Plot two shallow neural networks and the composition of the two. "

# ╔═╡ 1c7f78fe-96d7-4e73-b3c4-31a7c252ef6d
function PlotNeuralTwoComposition(xIn, Net1Out, Net2Out, Net12Out = nothing)
    # The two networks, side by side.
    p₁ = plot(xIn, Net1Out, color=:red, linestyle=:solid, legend=false,
              xlabel="Net 1 input", ylabel="Net 1 Output",
              xlims=(-1,1), ylims=(-1,1), aspect_ratio=1.0)
    p₂ = plot(xIn, Net2Out, color=:blue, linestyle=:solid, legend=false,
              xlabel="Net 2 input", ylabel="Net 2 Output",
              xlims=(-1,1), ylims=(-1,1), aspect_ratio=1.0)
...
# ╔═╡ 0d022bf4-e6b8-4aa0-84fa-ba21a58d0c32
md"Let's define two networks. We'll put the prefixes $n_1\_$ and $n_2\_$ before all the variables to make it clear which. We'll just consider the inputs and outputs over the range $[-1,1]$"
