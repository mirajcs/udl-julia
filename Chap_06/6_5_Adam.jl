...
# ╔═╡ 0c9513c1-12c7-4240-8b00-671773e3e066
using Symbolics

# ╔═╡ 3ab1986c-7c91-443f-a5cc-b108553e1461
using Latexify

# ╔═╡ db740655-6ced-4dc1-954c-67558b690c32
using Colors

# ╔═╡ 8ea6eb8a-c4f4-4d46-86d1-971432d59054
using CairoMakie
...
function DrawFunction(ϕ₀mesh, ϕ₁mesh, LossFunction, MyColorMap; OptPath= nothing)
	...
	if OptPath !== nothing
		scatterlines!(ax, OptPath[1, :], OptPath[2, :]; color = :green, linewidth = 2, markersize = 9, strokecolor = :black, strokewidth = 1)
	end
