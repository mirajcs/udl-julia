...
# ╔═╡ e6b1e8fb-a8b9-498d-a87a-b3d3c7738962
DrawLossFunction(ComputeLoss, Data, Model)

# ╔═╡ ce5b092d-285a-416e-b0e9-fb222f241c48
md"As before, we compute the gradient vector for a given set of parameters
...
# ╔═╡ 1ff2a50e-2359-4e45-b3a1-8645c7873deb
@variables ϕ₁ ϕ₂ x

# ╔═╡ 4c7e610b-41ca-46bf-be0b-99b795f7c733
dydϕ₁ = build_function(Symbolics.derivative(Model([ϕ₁,ϕ₂], x), ϕ₁), [ϕ₁,ϕ₂], x; expression = Val{false})

# ╔═╡ 8b538f9b-7baa-4ac9-aff1-e2c8b4390f03
