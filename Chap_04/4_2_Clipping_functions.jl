...
The purpose of this notebook is to understand how a neural network wth two hidden layers build more complicated functions by clipping and recombining the representations at the intermediate hidden variables. 
